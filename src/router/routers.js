    ...
    children: [
      {
        ...
        path: "",
        name: "analyzerChild",
        component: () => import("@/views/analyzer/analyzer.vue")
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        path: "",
        name: "loadbalancingChild",
        component: () => import("@/views/loadbalancing/loadbalancing.vue")
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        path: "",
        name: "parentChild",
        component: () => import("@/views/example/parent.vue")
      }
    ]
  }
];
